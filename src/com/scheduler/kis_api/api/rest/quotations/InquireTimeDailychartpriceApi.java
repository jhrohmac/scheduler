...
public class InquireTimeDailychartpriceApi extends CommonRestApi<InquireTimeDailychartpriceResult> {
    ...
    // Explicit setters for environments without Lombok annotation processing
    ...
    public void setFidFakeTickIncuYn(String fidFakeTickIncuYn) {
        this.fidFakeTickIncuYn = fidFakeTickIncuYn;
    }
