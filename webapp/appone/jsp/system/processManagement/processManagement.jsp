...
<div class="container-fluid" id="div_process_main">
	<div class="card card-primary card-outline">
		...
		<div class="card-body p-2">
			<div class="form-group search_row">
				<label for="sel_processName" class="col-sm-1 col-form-label" style="text-align: right;">Process Name</label>
				<div class="col-sm-3">
					<input type="text" id="sel_processName" name="sel_processName" onkeyup="fn_processGridOneData();"class="form-control form-control-sm" placeholder="프로세스 명">
				</div>
				...
				<div class="col-sm-1 common select-all" id="USE_YN">
					<select class="form-control custom-select custom-select-sm" id="sel_useYn" onchange="fn_processGridOneData();">
					</select>
				</div>
				<div class="col-sm-6">
		...
		<div class="col-4">
			<div class="card card-info">
					<div class="card-body table-responsive p-2">
						...
						<table class="table table-hover table-sm" id="processGridOneData">
							<thead>
								<tr>
									<th>No.</th>
									<th>Process ID</th>
			...
			<div class="card">
				...
				<div class="card-controls" style="text-align: right">
					...
					<table class="table table-hover table-sm" id="processGridTwoData">
						<thead>
							<tr>
								<th>No.</th>
								<th>Process ID</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="process_info_title">process 등록</h6>
...
<script>
	...
	function fn_processGridOneData() {
		// 호출 URL
		var url = "/scheduler/processManagement/selectProcessList.do";
		//조회 조건
		var param = {
					"sel_parentId" 		: "",
	                "sel_processDiv" 	: "main",
